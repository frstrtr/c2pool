...
void PoolNode::handle_message_version(std::shared_ptr<pool::messages::message_version> msg, PoolHandshake* handshake)
{
...
//            });
    ...
    auto id_update_remote_view_of_my_known_txs = known_txs->transitioned->subscribe([&, peer = (PoolProtocolData*)handshake, _socket = handshake->get_socket()](std::map<uint256, coind::data::tx_type> before, std::map<uint256, coind::data::tx_type> after){
    ...
    auto id_update_remote_view_of_my_mining_txs = mining_txs->transitioned->subscribe([&, peer = (PoolProtocolData*)handshake, socket = handshake->get_socket()] (std::map<uint256, coind::data::tx_type> before, std::map<uint256, coind::data::tx_type> after){
        std::map<uint256, coind::data::tx_type> added;
        std::set_difference(after.begin(), after.end(), before.begin(), before.end(), std::inserter(added, added.begin()));
...
void PoolNode::handle_message_addrs(std::shared_ptr<pool::messages::message_addrs> msg, PoolProtocol* protocol)
{
...
void PoolNode::handle_message_addrme(std::shared_ptr<pool::messages::message_addrme> msg, PoolProtocol* protocol)
{
...
void PoolNode::handle_message_ping(std::shared_ptr<pool::messages::message_ping> msg, PoolProtocol* protocol)
{
}

void PoolNode::handle_message_getaddrs(std::shared_ptr<pool::messages::message_getaddrs> msg, PoolProtocol* protocol)
{
...
void PoolNode::handle_message_shares(std::shared_ptr<pool::messages::message_shares> msg, PoolProtocol* protocol)
{
...
void PoolNode::handle_message_sharereq(std::shared_ptr<pool::messages::message_sharereq> msg, PoolProtocol* protocol)
{
...
void PoolNode::handle_message_sharereply(std::shared_ptr<pool::messages::message_sharereply> msg, PoolProtocol* protocol)
{
...
void PoolNode::handle_message_bestblock(std::shared_ptr<pool::messages::message_bestblock> msg, PoolProtocol* protocol)
{
    handle_bestblock(msg->header);
}

void PoolNode::handle_message_have_tx(std::shared_ptr<pool::messages::message_have_tx> msg, PoolProtocol* protocol)
{
...
void PoolNode::handle_message_losing_tx(std::shared_ptr<pool::messages::message_losing_tx> msg, PoolProtocol* protocol)
{
...
void PoolNode::handle_message_remember_tx(std::shared_ptr<pool::messages::message_remember_tx> msg, PoolProtocol* protocol)
{
...
void PoolNode::handle_message_forget_tx(std::shared_ptr<pool::messages::message_forget_tx> msg, PoolProtocol* protocol)
{
    for (auto tx_hash : msg->tx_hashes.get())
    {
        PackStream stream;
