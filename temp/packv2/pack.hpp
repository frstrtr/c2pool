...
#define FORMAT_METHODS(TYPE)\
    static void Write(PackStream &stream, const custom &obj) { FormatAction(stream, obj, SerializeFormatter{}); }\
    static void Read(PackStream &stream, custom &obj) { FormatAction(stream, obj, UnserializeFormatter{}); }\
