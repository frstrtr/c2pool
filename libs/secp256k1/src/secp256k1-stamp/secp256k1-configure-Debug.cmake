...
set(command "/snap/clion/169/bin/cmake/linux/bin/cmake;-DCMAKE_INSTALL_PREFIX=/home/sl33n/c2pool/libs/secp256k1;-DCMAKE_POSITION_INDEPENDENT_CODE=;-DCMAKE_C_COMPILER=/usr/bin/cc;-DCMAKE_CXX_COMPILER=/usr/bin/c++;-GCodeBlocks - Unix Makefiles;/home/sl33n/c2pool/libs/secp256k1/src/secp256k1")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/home/sl33n/c2pool/libs/secp256k1/src/secp256k1-stamp/secp256k1-configure-out.log")
set(stderr_log "/home/sl33n/c2pool/libs/secp256k1/src/secp256k1-stamp/secp256k1-configure-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/sl33n/c2pool/libs/secp256k1/src/secp256k1-stamp/secp256k1-configure-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "secp256k1 configure command succeeded.  See also /home/sl33n/c2pool/libs/secp256k1/src/secp256k1-stamp/secp256k1-configure-*.log")
    message(STATUS "${msg}")
  endif()
endif()
