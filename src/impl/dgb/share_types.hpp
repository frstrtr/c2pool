...
// SEGWIT_ACTIVATION_VERSION is the SHARE-VERSION (sharechain protocol) at which
// segwit data was added to shares — NOT a DGB coin-consensus constant.
// CONFIRMED against p2pool-merged-v36 reference networks/digibyte.py:
//   SEGWIT_ACTIVATION_VERSION = 17  (identical to LTC; shared V36 share format).
// Mirrors p2pool data.py is_segwit_activated(version, net):
//   return version >= seg && seg > 0.
