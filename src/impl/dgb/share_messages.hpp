...
// DGB share-wire messages (Phase B B1, Scrypt-only).
// Ported from src/impl/ltc/share_messages.hpp into the dgb:: namespace. The
// share-message wire format is shared V36 (identical to the LTC Scrypt parent and
// the p2pool-merged-v36 reference), so this ports verbatim with only the namespace
// swapped. COMPAT: frstrtr/p2pool-merged-v36; any divergence => [decision-needed].
//
