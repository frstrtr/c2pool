...
// DGB coin tx types. 1:1 mirror of src/impl/btc/coin/transaction.hpp
// (NON-MWEB; DGB has no MWEB extension block). Scrypt PoW divergence lives in
// header_chain.hpp, not here -- tx/script serialization is family-identical.
