...
// DGB coin-daemon P2P messages. 1:1 mirror of src/impl/btc/coin/p2p_messages.hpp
// (NON-MWEB: references base BlockType/MutableTransaction, NOT LTC MWEB types).
// Generic messages imported from bitcoin_family; coin-specific block/tx/headers
// + BIP152 cmpct messages defined here.
