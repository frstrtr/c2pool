...
// bch::coin TXIDCache -- ported verbatim from src/impl/btc/coin/txidcache.hpp.
// Coin-agnostic: maps getblocktemplate transaction.data -> hash256(packed data).
// No BCH divergence (CashTokens data rides inside the packed tx and hashes
// transparently; CTOR ordering does not affect the cache keying).
