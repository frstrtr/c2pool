...
struct BaseShare : chain::BaseShare<uint256, Version>
{
    ...
    bch::StaleInfo m_stale_info;        // stale_info
...
struct Share : BaseShare<17>
{
    ...
    bch::ShareTxInfo m_tx_info; // new_transaction_hashes; transaction_hash_refs
...
public:
    ...
    uint256 pow_hash;               // SHA256d hash, cached at reception (for block scan)
