...
struct Entry {
    ...
    const Upstream*  upstream;     // nullptr => authored fresh for c2pool
...
// The porting plan, one row per file. `upstream==nullptr` rows are fresh AGPL
...
inline constexpr std::array<Entry, 14> kManifest{{
    ...
    {"vendor/randomx/", &kRandomX, "src/ (whole library)", Disposition::Verbatim,
     License::BSD_3_Clause,
    ...
    {"vendor/monero-crypto/crypto-ops.c", &kMonero, "src/crypto/crypto-ops.c",
    ...
    {"vendor/monero-crypto/keccak.c", &kMonero, "src/crypto/keccak.c",
     Disposition::Verbatim, License::BSD_3_Clause,
    ...
    {"vendor/monero-crypto/tree-hash.c", &kMonero, "src/crypto/tree-hash.c",
     Disposition::Verbatim, License::BSD_3_Clause,
     "tree_hash / tree_branch: miner_tx is leaf 0; O(log n) inclusion proof."},
    {"vendor/monero-crypto/hash-ops.h", &kMonero, "src/crypto/hash-ops.h",
     Disposition::Verbatim, License::BSD_3_Clause, "cn_fast_hash / hash decls."},
    {"vendor/monero-epee/varint.h", &kMonero,
    ...
    {"src/impl/xmr/pow/randomx_hasher.cpp", &kP2pool, "src/pow_hash.cpp",
    ...
    {"src/impl/xmr/coinbase/det_tx_key.cpp", &kP2pool, "src/block_template.cpp",
     Disposition::Adapted, License::GPL_3_0_only,
    ...
    {"src/impl/xmr/coinbase/template_build.cpp", &kP2pool, "src/block_template.cpp",
     Disposition::Adapted, License::GPL_3_0_only,
    ...
    {"src/impl/xmr/rpc/monerod_adapter.cpp", &kP2pool,
    ...
    {"src/impl/xmr/stratum/cryptonote_stratum.cpp", &kP2pool, "src/stratum_server.cpp",
     Disposition::Adapted, License::GPL_3_0_only,
    ...
    {"src/impl/xmr/receipt/xmr_receipt.hpp", nullptr, "", Disposition::CleanRoom,
     License::AGPL_3_0,
    ...
    {"src/impl/xmr/settle/k_fair_xmr.cpp", nullptr, "", Disposition::CleanRoom,
     License::AGPL_3_0,
    ...
    {"src/impl/xmr/coinbase/keccak_midstate.c", nullptr, "", Disposition::CleanRoom,
     License::AGPL_3_0,
...
constexpr bool copyleft_preserved() {
    for (const auto& e : kManifest)
        if (e.upstream == &kP2pool && e.license != License::GPL_3_0_only)
            return false;
    return true;
}
