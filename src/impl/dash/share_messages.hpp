...
// DASH-X11 note: the SHA256/HMAC-SHA256/ECDSA message-signing layer here is the
// p2pool share-message crypto (PoW-algo-independent) -- identical to btc/dgb/ltc;
// it is NOT the X11 block PoW. Ported namespace-only to dash.
