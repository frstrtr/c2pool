// src/impl/ltc/catalog_defaults.hpp
//
...
#ifndef C2POOL_IMPL_LTC_CATALOG_DEFAULTS_HPP
#define C2POOL_IMPL_LTC_CATALOG_DEFAULTS_HPP

#include "core/settings_file.hpp"

namespace c2pool::impl::ltc {
...
inline void register_catalog_defaults(c2pool::settings::ResolvedConfig& rc) {
    ...
    rc.set("sharechain.listen", "0.0.0.0:9326", Source::CompiledDefault); // 9326 (ltc/config_pool.hpp:35 PoolConfig::P2P_PORT)
    rc.set("web.port", "8080", Source::CompiledDefault);                 // 8080 (main_ltc.cpp:629 http_port default)
    rc.set("money.give_author_pct", "0.1", Source::CompiledDefault);      // 0.1 (main_ltc.cpp:647 dev_donation default)
}

} // namespace c2pool::impl::ltc

#endif // C2POOL_IMPL_LTC_CATALOG_DEFAULTS_HPP
