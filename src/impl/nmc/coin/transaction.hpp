...
// NMC (Namecoin) transaction primitives.
//
// Mirror of src/impl/btc/coin/transaction.hpp — Namecoin is a Bitcoin fork and
// shares Bitcoin's transaction serialization format (witness-aware, BIP144).
// Re-homed into namespace nmc::coin so the NMC coin tree is self-contained and
// does not pull btc::coin symbols. Only core/* PUBLIC headers are used; no btc
// header is modified.
