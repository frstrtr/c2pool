...
// the fee model's "V37D" tail (and the V37C credit-cut tail). Receiver: P =
...
// The base B from a 0x02 payload: strip the V37C tail, then the V37D tail (each
// only if present), then read "V37N" u64le at the end. nullopt = no pay-now.
