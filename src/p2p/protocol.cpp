...
namespace c2pool::p2p
{
    ...
    void BaseProtocol::sendPacket(c2pool::messages::message *payload2)
    ...
    Protocol::Protocol(boost::asio::io_context io) : BaseProtocol(io, 3301)
    { //TODO: base constructor
    }

    Protocol::Protocol(boost::asio::io_context io, unsigned long _max_payload_length) : BaseProtocol(io, _max_payload_length, 3301)
    { //TODO: base constructor
    }
