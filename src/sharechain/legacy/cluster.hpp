...
{
public:
    using sum_element_type = SumElementType ;
...
{
public:
    using sum_element = SUM_ELEMENT;
    using value_type = typename SUM_ELEMENT::value_type;
    using hash_type = typename sum_element::hash_type;
    using ptr_node_type = std::shared_ptr<Node<sum_element>>;
public:
    // interval indexes:
    int index_l, index_r;
...
public:
    using  sum_element = SUM_ELEMENT;
    using value_type = typename sum_element::value_type;
    using node_type = Node<sum_element>;
    using ptr_node_type = std::shared_ptr<node_type>;
    using hash_type = typename sum_element::hash_type;
public:
    bool orientation{};
    int begin{}, end{};
