...
_addr = dict(services=1, address="192.168.10.10", port=1)
addr = address_type.pack(dict(services=1, address="192.168.10.10", port=1))
msg = message_version.pack(dict(version=1, services=2, addr_to=_addr, addr_from=_addr, nonce=321, sub_version="sub", mode=5, best_share_hash=123))
print(addr)
# print(msg)