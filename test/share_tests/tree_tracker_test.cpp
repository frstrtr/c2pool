...
class Sharechains2Test : public ::testing::Test
{
protected:
...
TEST_F(Sharechains2Test, tracker_base_tests)
{
...
TEST_F(Sharechains2Test, tracker_empty)
{
    std::shared_ptr<ShareTracker> tracker = std::make_shared<ShareTracker>(net);
...
TEST_F(Sharechains2Test, just_share_load)
{
...
/*TEST_F(Sharechains2Test, handle_share_test)
{
...
TEST_F(Sharechains2Test, tracker_one_share)
{
    std::shared_ptr<ShareTracker> tracker = std::make_shared<ShareTracker>(net);
...
TEST_F(Sharechains2Test, tracker_get_height_and_last)
{
    std::shared_ptr<ShareTracker> tracker = std::make_shared<ShareTracker>(net);
...
TEST_F(Sharechains2Test, tracker_think)
{
    std::shared_ptr<ShareTracker> tracker = std::make_shared<ShareTracker>(net);
...
TEST_F(Sharechains2Test, sharestore_only)
{
    std::shared_ptr<ShareTracker> tracker = std::make_shared<ShareTracker>(net);
...
TEST_F(Sharechains2Test, weights_test)
{
    std::shared_ptr<ShareTracker> tracker = std::make_shared<ShareTracker>(net);
...
TEST_F(Sharechains2Test, gentx_test)
{
    std::shared_ptr<ShareTracker> tracker = std::make_shared<ShareTracker>(net);
    ...
    auto generate_transaction = std::make_shared<shares::GenerateShareTransaction>(tracker);
...
TEST_F(Sharechains2Test, get_ref_hash_test)
{
    uint160 pubkey_hash;
    pubkey_hash.SetHex("78ecd67a8695aa4adc55b70f87c2fa3279cee6d0");

    shares::types::ShareData share_data {
    ...
    shares::types::ShareInfo share_info {
    ...
    std::optional<shares::types::SegwitData> segwit_data = std::make_optional<shares::types::SegwitData>(coind::data::MerkleLink{}, uint256::ZERO);
...
TEST_F(Sharechains2Test, get_ref_hash_test2)
{
    PackStream stream_share;
...
TEST_F(Sharechains2Test, share_pack_unpack)
{
    PackStream stream_share;
    stream_share.from_hex("");
    LOG_INFO << "stream_share len: " << stream_share.size();
...
TEST_F(Sharechains2Test, share_store_test)
{
    std::shared_ptr<ShareTracker> tracker = std::make_shared<ShareTracker>(net);
...
TEST(GenShareTxTest2, get_ref_hash_test)
{
