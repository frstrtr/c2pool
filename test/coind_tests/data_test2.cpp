...
TEST(CoindData, calculate_merkle_link_test)
{
    ...
    arr = {uint256::ZERO, uint256S("f57657b1b38a9766c736c9195d1df87f7053fcbbcc7540da12fb6afee7a2c58d"), uint256S("d85c2a7eefa6bf21ad0457ccbbcf3507f78fd1d5919c637c6679a83b1b75675f")};
    res = coind::data::calculate_merkle_link(arr, 1);

    ASSERT_EQ(res.branch.size(), 2);
    ...
    ASSERT_EQ(res.branch, assert_arr);
    ASSERT_EQ(res.index, 0);
}