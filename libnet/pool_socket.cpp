...
// Read
void PoolSocket::read_prefix(SocketPacket<ReadPacket>::ptr_type packet)
{
...
void PoolSocket::read_command(SocketPacket<ReadPacket>::ptr_type packet)
{
...
void PoolSocket::read_length(SocketPacket<ReadPacket>::ptr_type packet)
{
...
void PoolSocket::read_checksum(SocketPacket<ReadPacket>::ptr_type packet)
{
...
void PoolSocket::read_payload(SocketPacket<ReadPacket>::ptr_type packet)
{
...
void PoolSocket::final_read_message(SocketPacket<ReadPacket>::ptr_type packet)
{
	//checksum check
