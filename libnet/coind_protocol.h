...
{
public:
    CoindProtocol(boost::asio::io_context* context_, std::shared_ptr<BaseCoindSocket> socket_, HandlerManagerPtr handler_manager_, error_handler_type error_handler_) 
