...
public:
    Stratum(boost::asio::io_context* context, std::shared_ptr<ip::tcp::socket> socket, Worker* worker, std::function<void(std::tuple<std::string, unsigned short>)> _disconnect_in_node_f);
