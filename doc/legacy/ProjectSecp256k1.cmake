...
message(SECP256K1_LIBRARY "${prefix}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}secp256k1${CMAKE_STATIC_LIBRARY_SUFFIX}")
message(SECP256K1_INCLUDE_DIR "${prefix}/include")
...
ExternalProject_Add(
    ...
    PATCH_COMMAND ${CMAKE_COMMAND} -E copy_if_different
        ${prefix}/cmake/CMakeLists.txt <SOURCE_DIR>
