...
{
    boost::asio::async_write(*get_fundamental_socket(), boost::asio::buffer(net->PREFIX, net->PREFIX_LENGTH),
...
void P2PSocket::write_message_data(std::shared_ptr<Message> msg)
{
    ...
    boost::asio::async_write(*get_fundamental_socket(), boost::asio::buffer(_msg->data, _msg->len),
...
{
    boost::asio::async_read(*get_fundamental_socket(),
