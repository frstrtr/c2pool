...
# ])
#
# packed_inv_msg = arr_bytes_to_data('7 1 0 0 0 56 200 252 155 91 146 223 95 97 79 135 164 169 84 125 175 200 169 206 34 37 84 188 233 22 96 106 2 255 49 231 95 1 0 0 0 122 201 210 81 105 88 13 238 46 133 134 4 168 95 81 187 14 107 63 242 168 37 182 105 107 146 240 85 182 118 144 228 1 0 0 0 186 178 192 158 80 135 111 171 5 62 39 110 180 238 40 141 22 8 91 11 55 47 197 77 199 56 139 213 80 245 247 109 1 0 0 0 91 196 156 198 8 107 173 111 67 3 167 67 197 241 142 209 183 87 98 210 30 232 78 121 37 182 139 77 144 13 18 72 1 0 0 0 121 86 212 92 110 174 129 120 245 235 165 234 29 198 191 60 181 157 2 169 143 58 10 132 17 189 125 98 9 227 4 209 1 0 0 0 195 1 159 29 115 108 137 33 21 44 167 74 63 115 196 247 248 69 78 51 65 5 105 43 134 136 172 138 40 157 1 144 1 0 0 0 129 39 203 79 114 21 70 111 220 252 5 84 0 54 67 110 122 1 161 157 232 238 205 156 91 161 216 185 88 152 26 6')
# msg_inv = message_inv.unpack(packed_inv_msg)
# print(msg_inv)
...
packed_getdata_msg = arr_bytes_to_data('1 1 0 0 0 5 86 30 93 185 62 5 25 180 42 127 19 100 234 237 204 26 1 27 184 206 9 8 253 154 100 12 102 10 215 24 146')
msg_getdata = message_getdata.unpack(packed_getdata_msg)
print(msg_getdata)

# packed_getdata = arr_bytes_to_data('1 1 0 0 0 162 34 128 143 117 163 100 188 139 217 216 61 49 191 6 117 83 57 242 132 125 171 109 251 224 104 208 112 72 218 245 235')
# msg_getdata