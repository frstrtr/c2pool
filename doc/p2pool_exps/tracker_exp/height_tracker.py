...
class HeightTracker(object):
    ...
    def __init__(self, best_block_func, factory = None, backlog_needed = None):
...
# @defer.inlineCallbacks
def get_height_rel_highest_func(best_block_func, bitcoind = None, factory = None, net = None):
